...
EnterMarks(){
    ...
    ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/exam.jpg"));
       ...
       JLabel heading =new JLabel("Enter Marks of Students");
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/colle9.jpg"));
        Image i5= i4.getImage().getScaledInstance(900,700,Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel image1 = new JLabel(i6);
        image1.setBounds(0,0,1000,700);
        add(image1);
...
public void actionPerformed(ActionEvent ae){
    if(ae.getSource()== submit){
        try{
            ...
            String query2="insert into marks1 values('"+crollno.getSelectedItem()+"','"+cbsemester.getSelectedItem()+"','"+tfmarks1.getText()+"','"+tfmarks2.getText()+"','"+tfmarks3.getText()+"','"+tfmarks4.getText()+"','"+tfmarks5.getText()+"')";
