...
public  class Marks extends JFrame implements ActionListener{
  ...
  JButton cancel;
    ...
    Marks(String rollno){
        ...
        JLabel heading =new JLabel("FAMT");
        ...
        lblsemester.setBounds(60,120,500,20);
        ...
        add(sub5);
          ...
          try{
            ...
            ResultSet rs2 = c.s.executeQuery("select* from marks1 where rollno = '"+rollno+"'");
            while(rs2.next()){
        ...
        cancel.setBounds(250,500,120,20);
